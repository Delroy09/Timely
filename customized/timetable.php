...
<div class="container">
    ...
    <h2 style="margin:0; text-align:left">Class: <?php echo htmlspecialchars($className); ?> - <?php echo htmlspecialchars($classDiv); ?></h2>
    <br>

    <!-- Timetable buttons -->
    <div class="button-wrapper">
        <button data-btn type="button" style="cursor: pointer;">Generate timetable</button>
        <button class="clear-button" data-clear type="button" style="cursor: pointer;">Clear timetable</button>
    </div>
    <br>
